  ...
  return (
    <div ref={ref} className="relative w-full sm:w-auto">
      <input
        ...
        className="bg-bg-surface text-text-primary placeholder-text-secondary hover:border-border/80 focus:border-primary focus:ring-primary/30 h-9 w-full rounded-md border-0 px-3 text-sm transition-all duration-200 focus:ring-1 focus:outline-none sm:w-36"
      />
      {open && (
        <div className="bg-bg-surface absolute z-50 mt-1 rounded-md p-2">
          <DayPicker
            mode="single"
            selected={selected}
            month={displayMonth}
