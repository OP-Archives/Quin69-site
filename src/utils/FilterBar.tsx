      ...
      <div className="flex flex-row items-center gap-2 sm:gap-1">
        ...
        {showFilter && (
          <select
            ...
            className="bg-bg-surface text-text-primary hover:border-border/80 focus:border-primary focus:ring-primary/30 h-9 w-max rounded-md border-0 px-3 text-sm transition-all duration-200 focus:ring-1 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
          >
